...
export default {
  ...
  methods: {
    ...mapActions("scanned", ["GET_CODE", "CREATE_ADD_LOG", "VERIFY_HDF"]),
      ...
      confirm({
        ...
        if (result === true) {
          ...
          for (let idx in this.items) {
            // in is array index, of is object
      ...
      startMonitoring((newConnectionType) => {
        switch (newConnectionType) {
          ...
          case connectionType.wifi:
            ...
            if (
              !this._.isEmpty(this.noConnectionQR) &&
        ...
        confirm({
          ...
          if (result) {
            ...
            if (this.logoutUploadingClick === 1) {
              ...
              for (let idx in this.items) {
                this.GET_CODE(this.items[idx]).then((data) => {
                  if (this._.isEmpty(this.noConnectionQR)) {
